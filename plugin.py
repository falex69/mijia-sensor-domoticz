...
<plugin key="Domoticz-Xiaomi-Mijia-Plugin" name="Xiaomi Mijia Bluetooth Plugin" author="FALEX69" version="2.0.0" wikilink="https://https://github.com/falex69/mijia-sensor-domoticz/Readme.md" externallink="https://https://github.com/falex69/mijia-sensor-domoticz/">
    <description>
        <h2>Mijia Bluetooth Temp/Hygro Plugin 2.0.0</h2><br/>
        <h3>Features</h3>
        ...
        <h3>Configuration</h3>
        <ul style="list-style-type:square">
            <li>Device Bluetooth MAC-Address: Unique MAC address of the sensor.</li>
            <li>Device Index: Index number to store the values gather from the device.</li>
        </ul>
        <br/><br/>
    </description>
    <params>
        <param field="Mode1" label="MAC Addr" width="150px" required="true"/>
        <param field="Mode2" label="Device Idx" width="50px" required="true"/>
    </params>
</plugin>
"""
import Domoticz
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        self.deviceId = Parameters["Mode2"]
        self.macAddress = Parameters["Mode1"]
        #self.domoticzIp = Parameters["Address"]
        #self.domoticzPort = Parameters["Port"]
        #self.domoticzUser = Parameters["Username"]
        #self.domoticzPasswd = Parameters["Password"]
